<?php
	...
	function timezones_list(){
		...
		return array(
			...
			array('(UTC+04:00) Moscow, St. Petersburg, Volgograd',			'Europe/Moscow',		true,	'Moscow Standard Time',			'Moscow Daylight Time'),
			...
			array('(UTC+06:00) Ekaterinburg',					'Asia/Yekaterinburg',		false,	'Yekaterinburg Time',			'Yekaterinburg Summer Time'),
			...
			array('(UTC+07:00) Novosibirsk',					'Asia/Novosibirsk',		false,	'Novosibirsk Time',			'Novosibirsk Summer Time'),
			array('(UTC+08:00) Beijing, Chongqing, Hong Kong SAR, Urumqi',		'Asia/Chongqing',		true,	'China Standard Time',			null),
			array('(UTC+08:00) Krasnoyarsk',					'Asia/Krasnoyarsk',		false,	'Krasnoyarsk Time',			'Krasnoyarsk Summer Time'),
			...
			array('(UTC+10:00) Yakutsk',						'Asia/Yakutsk',			false,	'Yakutsk Time',				'Yakutsk Summer Time'),
			...
			array('(UTC+11:00) Vladivostok',					'Asia/Vladivostok',		false,	'Vladivostok Time',			'Vladivostok Summer Time'),
