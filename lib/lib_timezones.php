<?php
	...
	function timezones_list(){
		...
		return array(
			...
			array('(UTC+04:00) Astrakhan, Ulyanovsk', 'Europe/Astrakhan', false, 'Moscow Standard Time', 'Moscow Standard Time +1'),
			...
			array('(UTC+06:00) Novosibirsk', 'Asia/Novosibirsk', false, 'Novosibirsk Time', NULL),
